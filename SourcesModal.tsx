...
import { X, Shield, BookOpen, Brain, FileText, Globe, ChevronDown, ChevronUp, Link, Lock, Microscope, Radio, Lightbulb, ExternalLink, Cpu, Zap, Monitor, Eye, Activity } from 'lucide-react';
            ...
            deepDive: [
                {
                    ...
                    content: "Persinger's work suggests that micro-seizures or specific firing patterns in the temporal lobes are responsible for the feeling of 'God' or 'Universal Connection'. SynSync's 'Speculative' protocols attempt to mimic these firing patterns using audio modulation."
                }
            ]
        }
    ],
    tmi: [
        {
            ...
            code: "TMI-RESEARCH",
            icon: Brain,
            summary: "Founded by Robert Monroe, TMI classified altered states into 'Focus Levels'. SynSync reconstructs these states using modern DSP.",
            deepDive: [
                {
        ...
        },
        {
            ...
            subtitle: "The Peniston Protocol",
            code: "ALPHA-THETA",
            icon: Activity,
            summary: "Research demonstrating the efficacy of Alpha-Theta training for addiction recovery and PTSD.",
            deepDive: [
                {
                    heading: "Peniston & Kulkosky (1989)",
                    content: "A landmark study showing an 80% long-term abstinence rate in alcoholics treated with Alpha-Theta neurofeedback, compared to 20% in the control group. The mechanism involves processing suppressed trauma in a hypnagogic state."
                },
                {
                    heading: "SMR Training",
                    content: "Sensorimotor Rhythm (12-15Hz) training is shown to improve impulse control and reduce motor agitation, critical for managing withdrawal symptoms."
                }
            ]
        },
        {
            title: "Clinical Applications",
            subtitle: "Pain & Depression",
            code: "MEDICAL-DSP",
            icon: Activity,
            summary: "Medical research supporting the use of specific frequencies for chronic pain management and mood elevation.",
            deepDive: [
                {
                    heading: "Chronic Pain (Ecsy et al. 2017)",
                    content: "Studies indicate that 10Hz Alpha stimulation can disrupt Thalamocortical Dysrhythmia (TCD), a neural loop associated with chronic pain, significantly raising the pain threshold."
                },
                {
                    heading: "Depression (Cantou et al. 2018)",
                    content: "Beta and Gamma entrainment are used to counteract 'Frontal Alpha Asymmetry', increasing cortical activation and improving mood scores in depressive patients."
                }
            ]
        }
    ],
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 backdrop-blur-md animate-in fade-in duration-200">
            <div className="bg-neuro-900 border border-neuro-700 w-full max-w-6xl h-[90vh] rounded-2xl shadow-2xl flex flex-col overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row flex-1 overflow-hidden">
                    ...
                    {/* Main Content Area */}
                    <div className="flex-1 overflow-y-auto p-4 md:p-8 custom-scrollbar bg-black/20 pb-32">
